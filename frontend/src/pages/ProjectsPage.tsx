    ...
    <>
      <main className="relative mx-auto max-w-7xl overflow-hidden px-5 py-20">
        ...
        <div className="relative z-10 mb-14 max-w-3xl">
          <p className="mb-2 text-sm font-semibold uppercase tracking-wider text-clay">Works</p>
          <h1 className="font-display text-5xl italic leading-tight text-ink md:text-7xl">Projects</h1>
          <p className="mt-6 text-lg leading-relaxed text-graphite">
            Case studies, experiments, and shipped interfaces collected in one place.
          </p>
        </div>
        {isLoading ? (
          <div className="flex h-64 items-center justify-center font-medium text-clay">Loading projects...</div>
        ) : (
